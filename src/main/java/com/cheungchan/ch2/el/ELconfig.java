...
@Configuration
@ComponentScan("com.cheungchan.ch2.el")
@PropertySource("classpath:com/cheungchan/ch2/el/test.properties")// 注入配置文件
public class ELconfig {
	...
	@Value("classpath:com/cheungchan/ch2/el/test.txt")//注入文件资源
